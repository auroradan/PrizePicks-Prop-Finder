...
class MLB_PRIZEPICKS_EXCEL():
    ...
    def create_xlsx(self):
        ...
        with pd.ExcelWriter('EXCEL_PRIZEPICKS_DATA/mlb_prizepicks_data.xlsx', engine='xlsxwriter') as writer:
            df.to_excel(writer, index=False, sheet_name='All_Data')

        print("Excel file 'mlb_prizepicks_data.xlsx' created successfully.")
