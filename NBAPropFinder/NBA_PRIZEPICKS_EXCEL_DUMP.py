...
class NBA_PRIZEPICKS_EXCEL():
    ...
    def create_xlsx(self):
        ...
        with pd.ExcelWriter('EXCEL_PRIZEPICKS_DATA/nba_prizepicks_data.xlsx', engine='xlsxwriter') as writer:
            df.to_excel(writer, index=False, sheet_name='All_Data')

        print("Excel file 'nba_prizepicks_data.xlsx' created successfully.")
