from NonPropFinderSports.LOL.PRIZEPICKS_LOL_SCRAPER import PRIZEPICKS_LOL_SCRAPER
from collections import defaultdict
import pandas as pd

class LOL_PRIZEPICKS_EXCEL():
    
    def __init__(self):
        self.prizepicks_data = PRIZEPICKS_LOL_SCRAPER().lines
        self.categories = []
    ...
    def create_xlsx(self):
        ...
        with pd.ExcelWriter('EXCEL_PRIZEPICKS_DATA/lol_prizepicks_data.xlsx', engine='xlsxwriter') as writer:
            df.to_excel(writer, index=False, sheet_name='All_Data')

        print("Excel file 'lol_prizepicks_data.xlsx' created successfully.")
