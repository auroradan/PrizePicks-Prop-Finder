from NonPropFinderSports.PGA.PRIZEPICKS_PGA_SCRAPER import PRIZEPICKS_PGA_SCRAPER
from collections import defaultdict
import pandas as pd

class PGA_PRIZEPICKS_EXCEL():
    
    def __init__(self):
        self.prizepicks_data = PRIZEPICKS_PGA_SCRAPER().lines
        self.categories = []
    ...
    def create_xlsx(self):
        ...
        with pd.ExcelWriter('EXCEL_PRIZEPICKS_DATA/pga_prizepicks_data.xlsx', engine='xlsxwriter') as writer:
            df.to_excel(writer, index=False, sheet_name='All_Data')

        print("Excel file 'pga_prizepicks_data.xlsx' created successfully.")
