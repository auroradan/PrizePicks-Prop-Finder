from NonPropFinderSports.TENNIS.PRIZEPICKS_TENNIS_SCRAPER import PRIZEPICKS_TENNIS_SCRAPER
from collections import defaultdict
import pandas as pd

class TENNIS_PRIZEPICKS_EXCEL():
    
    def __init__(self):
        self.prizepicks_data = PRIZEPICKS_TENNIS_SCRAPER().lines
        self.categories = []
    ...
    def create_xlsx(self):
        ...
        with pd.ExcelWriter('EXCEL_PRIZEPICKS_DATA/tennis_prizepicks_data.xlsx', engine='xlsxwriter') as writer:
            df.to_excel(writer, index=False, sheet_name='All_Data')

        print("Excel file 'tennis_prizepicks_data.xlsx' created successfully.")
