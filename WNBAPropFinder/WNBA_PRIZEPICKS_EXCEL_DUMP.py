...
class WNBA_PRIZEPICKS_EXCEL():
    ...
    def create_xlsx(self):
        ...
        with pd.ExcelWriter('EXCEL_PRIZEPICKS_DATA/wnba_prizepicks_data.xlsx', engine='xlsxwriter') as writer:
            df.to_excel(writer, index=False, sheet_name='All_Data')

        print("Excel file 'wnba_prizepicks_data.xlsx' created successfully.")
